			...
			<tbody>
				...
				<tr>
					...
					<td>
						<% if(myStepNumber.equals("7") || !signupSelectPackageFormComplete.equals("true")) { %>
							<ao:message key="steps.selectDomain.label" />
						<% } else { %>
							<a class="aoDarkLink" href="javascript:selectStep('<ao:write scope="request" name="actionPrefix" />-2');"><ao:message key="steps.selectDomain.label" /></a>
						<% } %>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<% } else { %>
							<a class="aoDarkLink" href="javascript:selectStep('<ao:write scope="request" name="actionPrefix" />-3');"><ao:message key="steps.organizationInfo.label" /></a>
						<% } %>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<% } else { %>
							<a class="aoDarkLink" href="javascript:selectStep('<ao:write scope="request" name="actionPrefix" />-4');"><ao:message key="steps.technicalInfo.label" /></a>
						<% } %>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<% } else { %>
							<a class="aoDarkLink" href="javascript:selectStep('<ao:write scope="request" name="actionPrefix" />-5');"><ao:message key="steps.billingInformation.label" /></a>
						<% } %>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<% } else { %>
							<a class="aoDarkLink" href="javascript:selectStep('<ao:write scope="request" name="actionPrefix" />-6');"><ao:message key="steps.confirmation.label" /></a>
						<% } %>
					</td>
					<td>
