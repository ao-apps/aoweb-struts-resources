							...
							<skin:lightArea>
								...
								<table cellspacing="0" cellpadding="2">
									...
									<c:if test="${!empty currency}">
										...
										<c:if test="${!empty balance}">
											<tr>
												...
												<th style='white-space:nowrap' align='left'><ao:message key="makePaymentStoredCard.accountBalance.prompt" /></th>
									...
									<tr>
										...
										<th style='white-space:nowrap' align='left'><ao:message key="makePaymentStoredCard.paymentAmount.prompt" /></th>
										<td style="white-space:nowrap">
											<ao:choose>
									...
									<tr>
										<td style="white-space:nowrap"><ao:message key="creditCardForm.required.no" /></td>
										<th style='white-space:nowrap' align='left'><ao:message key="makePaymentNewCard.storeCard.prompt" /></th>
										<td style='white-space:nowrap' colspan="2">
											<label><html:radio property="storeCard" value=""><ao:message key="makePaymentNewCard.storeCard.no" /></html:radio></label><br />
											<label><html:radio property="storeCard" value="store"><ao:message key="makePaymentNewCard.storeCard.store" /></html:radio></label><br />
